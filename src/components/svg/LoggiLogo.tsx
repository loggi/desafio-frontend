...
// const SvgComponent = ({ primary = "#00BAFF" }: LoggiLogoProps) => (
const SvgComponent = (props: LoggiLogoProps) => (
  <svg
  ...
  >
    <defs>
      <path id="a" d="M25.485 25.043H39.03V4.605H25.485z" />
      <path id="c" d="M39.667 25.043h13.544V4.605H39.667v20.438z" />
      <path id="e" d="M-34 25.043h91.876v-30.03H-34z" />
    </defs>
    <g fill="none" fillRule="evenodd">
      <g className="letters" transform="translate(34 5)">
        <path
          fill={props.color}
          d="M3.46 0H0v18h11v-3.303H3.46zM18.05 14.902c-2.055-.014-3.51-1.555-3.488-3.693.023-2.128 1.467-3.603 3.526-3.6 2.077.001 3.508 1.498 3.499 3.66-.01 2.15-1.467 3.648-3.536 3.633Zm.035-10.287c-3.841-.013-6.783 2.862-6.782 6.63 0 3.775 2.927 6.646 6.77 6.644 3.867-.003 6.775-2.85 6.774-6.631 0-3.798-2.882-6.629-6.762-6.643Z"
        />
        {"{/*"}
        <mask id="b" fill="#fff">
          <use xlinkHref="#a" />
        ...
        <path
          fill={props.color}
          d="M54.53 17.698h3.346V4.605h-3.345zM56.204 3.342a1.673 1.673 0 1 0 0-3.346 1.673 1.673 0 0 0 0 3.346"
          mask="url(#f)"
        />
      </g>
      <g fill={props.color} className="rabbit">
        <path
